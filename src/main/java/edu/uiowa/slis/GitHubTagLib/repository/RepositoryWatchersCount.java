...
public class RepositoryWatchersCount extends GitHubTagLibTagSupport {
	...
	private static final Logger log = LogManager.getLogger(RepositoryWatchersCount.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: Can't find enclosing Repository for watchersCount tag ");
	...
	public int getWatchersCount() throws JspException {
		try {
			Repository theRepository = (Repository)findAncestorWithClass(this, Repository.class);
	...
	public void setWatchersCount(int watchersCount) throws JspException {
		try {
			Repository theRepository = (Repository)findAncestorWithClass(this, Repository.class);
