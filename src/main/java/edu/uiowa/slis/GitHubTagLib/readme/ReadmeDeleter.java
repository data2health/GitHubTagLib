...
public class ReadmeDeleter extends GitHubTagLibBodyTagSupport {
	...
	private static final Logger log = LogManager.getLogger(ReadmeDeleter.class);
    ...
    public int doStartTag() throws JspException {
        ...
        try {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: JDBC error generating Readme deleter");
				return parent.doEndTag();
			}else{
				throw new JspException("Error: JDBC error generating Readme deleter",e);
			}
