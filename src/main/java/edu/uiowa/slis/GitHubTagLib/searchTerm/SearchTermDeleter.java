...
public class SearchTermDeleter extends GitHubTagLibBodyTagSupport {
	...
	private static final Logger log = LogManager.getLogger(SearchTermDeleter.class);
    ...
    public int doStartTag() throws JspException {
        ...
        try {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: JDBC error generating SearchTerm deleter");
				return parent.doEndTag();
			}else{
				throw new JspException("Error: JDBC error generating SearchTerm deleter",e);
			}
