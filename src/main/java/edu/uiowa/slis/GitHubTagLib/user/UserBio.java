...
public class UserBio extends GitHubTagLibTagSupport {
	...
	private static final Logger log = LogManager.getLogger(UserBio.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: Can't find enclosing User for bio tag ");
	...
	public String getBio() throws JspException {
		try {
			User theUser = (User)findAncestorWithClass(this, User.class);
	...
	public void setBio(String bio) throws JspException {
		try {
			User theUser = (User)findAncestorWithClass(this, User.class);
			theUser.setBio(bio);
		} catch (Exception e) {
