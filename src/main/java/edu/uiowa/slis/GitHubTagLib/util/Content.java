...
public class Content {
	...
	static void write(String owner, String repo, String path, String content, String message, boolean rewrite)
			throws IOException {
	...
	static void update(String owner, String repo, String path, String pattern, String replacement, String message)
			throws IOException {
